...
CREATE TABLE IF NOT EXISTS chi_tiet_hoa_don (
    ...
    CONSTRAINT fk_ct_hd FOREIGN KEY (ma_hd) REFERENCES hoa_don(ma_hd),
    CONSTRAINT fk_ct_sp FOREIGN KEY (ma_sp) REFERENCES san_pham(ma_sp)
);
...
INSERT IGNORE INTO danh_muc(ten_dm) VALUES
('Ban phim'), ('Chuot'), ('USB'), ('Tai nghe');

INSERT IGNORE INTO san_pham(ten_sp, don_gia, so_luong, ma_dm)
SELECT 'Ban phim Logitech K120', 180000, 50, ma_dm FROM danh_muc WHERE ten_dm='Ban phim';
INSERT IGNORE INTO san_pham(ten_sp, don_gia, so_luong, ma_dm)
SELECT 'Chuot khong day Rapoo', 220000, 40, ma_dm FROM danh_muc WHERE ten_dm='Chuot';
INSERT IGNORE INTO san_pham(ten_sp, don_gia, so_luong, ma_dm)
SELECT 'USB Kingston 32GB', 150000, 100, ma_dm FROM danh_muc WHERE ten_dm='USB';
INSERT IGNORE INTO san_pham(ten_sp, don_gia, so_luong, ma_dm)
SELECT 'Tai nghe Sony Basic', 350000, 30, ma_dm FROM danh_muc WHERE ten_dm='Tai nghe';

INSERT IGNORE INTO khach_hang(ten_kh, sdt, dia_chi) VALUES
