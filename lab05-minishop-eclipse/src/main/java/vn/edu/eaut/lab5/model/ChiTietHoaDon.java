...
public class ChiTietHoaDon {
    ...
    public int getSoLuong(){return soLuong;} public void setSoLuong(int v){soLuong=v; tinh();}
    public BigDecimal getDonGia(){return donGia;} public void setDonGia(BigDecimal v){donGia=v;tinh();}
    public BigDecimal getThanhTien(){return thanhTien;} public void setThanhTien(BigDecimal v){thanhTien=v;}
    private void tinh(){if(donGia!=null) thanhTien=donGia.multiply(BigDecimal.valueOf(soLuong));}
}
